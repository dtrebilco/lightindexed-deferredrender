...
void initExtensions(){
  ...
  GL_EXT_depth_bounds_test_supported = isExtensionSupported("GL_EXT_depth_bounds_test");

#ifdef GL_EXT_depth_bounds_test_PROTOTYPES
  if(GL_EXT_depth_bounds_test_supported) {
    glDepthBoundsEXT = (PFNGLDEPTHBOUNDSEXTPROC) wglxGetProcAddress("glDepthBoundsEXT");
  }
#endif
