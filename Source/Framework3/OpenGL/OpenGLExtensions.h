...
#if !defined(GL_EXT_depth_bounds_test) || defined(PROTOTYPES)
#define GL_EXT_depth_bounds_test_PROTOTYPES
#endif
...
typedef void (APIENTRY * PFNGLDRAWRANGEELEMENTSEXTPROC) (GLenum  mode, GLuint start, GLuint end, GLsizei count, GLenum type, const void *indices);
#endif
...
typedef void (APIENTRY * PFNGLTEXSUBIMAGE3DPROC)(GLenum target, GLint lod, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei w, GLsizei h, GLsizei d, GLenum format, GLenum type, const void *buf);
...
#ifdef GL_EXT_depth_bounds_test_PROTOTYPES
